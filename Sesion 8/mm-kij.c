...
int main() {
  ...
  for (k=0; k<N; k++) 
    ...
    //C: primero se declara i (row) y luego j (col) -> horizontal
    //A: primero se declara k (col) y luego i (row) -> vertical
    //B: primero se declara k (row) y luego j (col) -> horizontal
